...
/*
 * *createdBy aiwalia]a
 * AdminBusinessService is used to implement Admin services
 * */
@Service
public class AdminBusinessService {
    ...
    /*This method is implemented for the purpose of deleting the user from the database.
     * This method uses adminDao to connect to the database and to fetch the details of the user to be deleted
     * and to verify the authtoken of the requesting user.
     * the adminDao returns the information regarding authToken and user and checks for logged in user as admin
     * are made.
