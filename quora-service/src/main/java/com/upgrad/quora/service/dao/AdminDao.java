...
public class AdminDao {
    ...
    /*
     *This method is used to get the auth token of the logged in user or the requesting user so that they
     * are authorised by matching the accesstoken from DB
     * Method uses a name query to fetch user auth details from userauth table using accesstoken.
     * If the details doesnt exist in DB then it throws exception which is caught and a null value is returned to the calling business class.
     *
     * */
